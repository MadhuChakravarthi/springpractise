...
function personalform_required(A)
    {
        var j=0;
        A=A?A:"ALL";
        var values=new Array();
        values[j++]=new Array('property(personal_firstname)', 'FirstName Required.', new Function ('varName', ' return this[varName];'));
        values[j++]=new Array('property(personal_social)', 'Social status Required.', new Function ('varName', ' return this[varName];'));
        values[j++]=new Array('property(personal_laname)', 'LastName Required.', new Function ('varName', ' return this[varName];'));
        values[j++]=new Array('property(personal_faname)', 'Father/Guardian/Husband Name Required.', new Function ('varName', ' return this[varName];'));
        values[j++]=new Array('property(personal_relation)', 'Relationship Required.', new Function ('varName', ' return this[varName];'));
        values[j++]=new Array('property(personal_hmaddr)', 'DoorNo/Street Required.', new Function ('varName', ' return this[varName];'));
        values[j++]=new Array('property(personal_gender)', 'Gender Required.', new Function ('varName', ' return this[varName];'));
        //values[j++]=new Array('property(personal_state)', 'State Required.', new Function ('varName', ' return this[varName];'));
        values[j++]=new Array('property(personal_dob)', 'Dob Required.', new Function ('varName', ' return this[varName];'));
...
function personalform_mask(A)
    {
        var j=0;
        A=A?A:"ALL";
        var values=new Array();
       values[j++]=new Array('property(personal_firstname)', 'FirstName Invalid Input', new Function ('varName', 'this.mask=/^[a-zA-Z\\s]*$/; return this[varName];'));
       values[j++]=new Array('property(personal_middlename)', 'Middle Name Invalid Input', new Function ('varName', 'this.mask=/^[a-zA-Z\\s]*$/; return this[varName];'));
       values[j++]=new Array('property(personal_laname)', 'Last Name Invalid Input', new Function ('varName', 'this.mask=/^[a-zA-Z\\s]*$/; return this[varName];'));
       values[j++]=new Array('property(personal_social)', 'Socail Status Invalid Input', new Function ('varName', 'this.mask=/^[a-zA-Z\\s]*$/; return this[varName];'));
       values[j++]=new Array('property(personal_relation)', 'Relationship Invalid Input', new Function ('varName', 'this.mask=/^[a-zA-Z\\s]*$/; return this[varName];'));
       values[j++]=new Array('property(personal_faname)', 'Father Name Invalid Input', new Function ('varName', 'this.mask=/^[a-zA-Z\\s]*$/; return this[varName];'));
       values[j++]=new Array('property(personal_gender)', 'Gender Invalid Input', new Function ('varName', 'this.mask=/^[a-zA-Z\\s]*$/; return this[varName];'));
       values[j++]=new Array('property(personal_dob)', 'Date of Birth Invalid Input', new Function ('varName', 'this.mask=/^[0-9-\\s]*$/; return this[varName];'));
