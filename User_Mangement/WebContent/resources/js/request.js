...
function getCollgeList()
{
    ...
    //var state=statecode.value;
    //alert(param);
    var url = "colllist.jsp"; // The server-side script
   // var statecode= SMSForm.distcode.value;
    //var param=state;
    http.open("GET", url , true);
    http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    http.onreadystatechange = setCollgeList;
    http.send(null);
}


function setCollgeList()
{
    ...
    if (http.readyState == 4) {
        ...
        //alert("No course exists with this training type");
            ...
            // if(document.getElementById("mandalcode").options.length!=1)
            //{
            document.forms[0].coursetrgat.options.length = 0;
            //}
            var oOption1 = document.createElement("OPTION");
            oOption1.text=trim("- - - - - - select - - - - - - -");
            oOption1.value=trim("");
            document.forms[0].coursetrgat.options.add(oOption1);
            ...
            for(var i=0;i<results.length-1;i++)
            {
                ...
                for(var j=0;j<results1.length-1;j++)
                {
                    var oOption = document.createElement("OPTION");
                    oOption.text=trim(results1[1]);
                    oOption.value=trim(results1[1].trim());
                    //alert(oOption.value);
                    document.forms[0].coursetrgat.options.add(oOption);
...
function getCollgeList1()
{
    ...
    //var state=statecode.value;
    //alert(param);
    var url = "schlist.jsp"; // The server-side script
   // var statecode= SMSForm.distcode.value;
    //var param=state;
    http.open("GET", url , true);
    http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    http.onreadystatechange = setCollgeList1;
    http.send(null);
}


function setCollgeList1()
{
    ...
    if (http.readyState == 4) {
        ...
        //alert("No course exists with this training type");
            ...
            // if(document.getElementById("mandalcode").options.length!=1)
            //{
            document.forms[0].nurcourse.options.length = 0;
            //}
            var oOption1 = document.createElement("OPTION");
            oOption1.text=("- - - - - - select - - - - - - -");
            oOption1.value=("");
            document.forms[0].nurcourse.options.add(oOption1);
            ...
            for(var i=0;i<results.length-1;i++)
            {
                ...
                for(var j=0;j<results1.length-1;j++)
                {
                    var oOption = document.createElement("OPTION");
                    oOption.text=(results1[1]);
                    oOption.value=(results1[1].trim());
                    document.forms[0].nurcourse.options.add(oOption);

                }
            }
            //midwife
             document.forms[0].midcourse.options.length = 0;
            //}
            var oOption1 = document.createElement("OPTION");
            oOption1.text=("- - - - - - select - - - - - - -");
            oOption1.value=("");
            document.forms[0].midcourse.options.add(oOption1);
            ...
            for(var i=0;i<results.length-1;i++)
            {
                ...
                for(var j=0;j<results1.length-1;j++)
                {
                    ...
                    oOption.text=(results1[1]);
                    oOption.value=(results1[1].trim());
                    document.forms[0].midcourse.options.add(oOption);
...
function getCollgeList2()
{
    ...
    //var state=statecode.value;
    //alert(param);
    var url = "hwlist.jsp"; // The server-side script
   // var statecode= SMSForm.distcode.value;
    //var param=state;
    http.open("GET", url , true);
    http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    http.onreadystatechange = setCollgeList2;
    http.send(null);
}


function setCollgeList2()
{
    ...
    if (http.readyState == 4) {
        ...
        //alert("No course exists with this training type");
            ...
            var j=0;
            var course=document.forms[0].coursetrgat;
            for(var i=0;i<results.length-1;i++)
            {
                results1=results[i].split(";");
                for(var j=0;j<results1.length-1;j++)
...
function getCollgeListmsc()
{
    ...
    //var state=statecode.value;
    //alert(param);
    var url = "msccolllist.jsp"; // The server-side script
   // var statecode= SMSForm.distcode.value;
    //var param=state;
    http.open("GET", url , true);
    http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    http.onreadystatechange = setCollgeListmsc;
    http.send(null);
}


function setCollgeListmsc()
{
