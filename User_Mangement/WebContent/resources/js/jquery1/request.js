...
function getpackage()
{
    ...
    var url = "./ajaxgetPackage.jsp?param="; // The server-side script
    var statecode= document.forms[0].projectname.value;
    http.open("GET", url + escape(statecode), true);
    http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    http.onreadystatechange = setpackage;
    http.send(null);
}
function setpackage()
{
    ...
    if (http.readyState == 4) {
        ...
        //alert("No course exists with this training type");
            ...
            //alert("calling---------getPackage");
            // if(document.getElementById("districtcode").options.length!=1)
            //{
               
            document.forms[0].packagename.length = 0;
            //}
            var oOption1 = document.createElement("OPTION");
            oOption1.text=trim("---select---");
            oOption1.value=trim("");
            document.forms[0].packagename.options.add(oOption1);

            var j=0;
            var course=document.forms[0].packagename;
            for(var i=0;i<results.length-1;i++)
            {
                ...
                for(var j=0;j<results1.length-1;j++)
                {
                    ...
                    document.forms[0].packagename.options.add(oOption);
...
{
    //alert("hai11");
    var url = "./ajaxgetassignment.jsp?param="; // The server-side script
    var statecode= document.forms[0].projectname.value;
    //alert(statecode);
    http.open("GET", url + escape(statecode), true);
    http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    http.onreadystatechange = setassignment;
    http.send(null);
}
function setassignment()
{
    ...
    if (http.readyState == 4) {
        ...
        // alert("No course exists with this training type");
            ...
            document.forms[0].assignment.length = 0;
            //}
            var oOption1 = document.createElement("OPTION");
            oOption1.text=trim("---select---");
            oOption1.value=trim("");
            document.forms[0].assignment.options.add(oOption1);

            var j=0;
            var course=document.forms[0].assignment;
            for(var i=0;i<results.length-1;i++)
            {
                results1=results[i].split(";");
                for(var j=0;j<results1.length-1;j++)
                {
                    ...
                    oOption.text=trim(results1[1]);
                    oOption.value=trim(results1[0]);
                    document.forms[0].assignment.options.add(oOption);
...
function getassign()
{
    ...
    http.open("GET", url + escape(statecode), true);
    http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    http.onreadystatechange = setassign;
    http.send(null);
}
function setassign()
{
...
{
    //alert("hai11");
    var url = "./ajaxgetwebfolder.jsp?param="; // The server-side script
    var statecode= document.forms[0].projectname.value;
    //alert(statecode);
    http.open("GET", url + escape(statecode), true);
    http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    http.onreadystatechange = setwebfolder;
    http.send(null);
}
